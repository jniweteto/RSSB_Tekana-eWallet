...
let TransactionController = class TransactionController {
    ...
    getAllTransactions(customerId = null, walletId = 0) {
        if (customerId != null) {
    ...
    createTransaction(transaction, errorMessage = null) {
        try {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [transaction_entity_1.Transaction, String]),
    __metadata("design:returntype", Promise)
